...
<tr>
                                            ...
                                            ?>
                                                        ...
                                                        <td>
                                                            <a href="updateparents.php" class="btn btn-sm btn-primary">Update</a><span></span></td>
                                                            <td><a href="deleteparents.php?parent_id=<?php echo $row["parent_id"]; ?>" class="btn btn-sm btn-danger">Delete</a>
                                                        </td>                                               
                                                    </tr>
