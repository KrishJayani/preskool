...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE teachers set teachers_id='" . $_POST['teachers_id'] . "', name='" . $_POST['name'] . "', address='" . $_POST['address'] . "', phone_no='" . $_POST['phone_no'] . "', course='" . $_POST['course'] . "', salary='" . $_POST['salary'] . "' WHERE teachers_id='" . $_POST['teachers_id'] . "'");
 header("Location: allteachers.php", true, 301);
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM teachers WHERE teachers_id='" . $_GET['teachers_id'] . "'");
...
<span class="user-img">
<img class="rounded-circle" src="assets/img/profiles/avatar-01.jpg" width="31" alt="Jassa Rich">
<div class="user-text">
<h6>Jassa Rich</h6>
...
<input class="form-control" type="text" placeholder="Enter Id" name="teachers_id" required>
</div>
</div>
...
<input class="form-control" type="text" placeholder="Enter Mobile Number" name="phone_no" required>
</div>
</div>
...
<input class="form-control" type="address" placeholder="Enter address" name="address"> 
</div>
</div>
...
<div class="form-group local-forms">
<label>Salary:£ </label>
<input class="form-control" type="text" placeholder="Enter salary :£" name="salary" required>
</div>
</div>
