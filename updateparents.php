...
<div class="row">
<div class="col-12">
<h5 class="form-title student-info">Parents Information <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
</div>

<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Parents Id <span class="login-danger">*</span></label>
<input class="form-control" type="text" placeholder="Enter Parents Id" name="parent_id" required>
</div>
</div>
